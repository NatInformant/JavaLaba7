...
import JavaLaba7.Model.FileSystemElement;
...
public class FileSystemElementsService {
    ...
    private static void GetFileSystemElement(File fileSystemElement) {
        if (fileSystemElement.isFile()) {
            ...
            fileSystemElementsInCurrentDir.add(new JavaLaba7.Model.File(
                    currentFileName,
            ...
            fileSystemElementsInCurrentDir.add(new JavaLaba7.Model.Directory(
                    currentDirName,
